...
set_property -dict {PACKAGE_PIN AE26 IOSTANDARD LVCMOS25} [get_ports {usr_led[4]}]
set_property -dict {PACKAGE_PIN G19  IOSTANDARD LVCMOS25} [get_ports {usr_led[5]}]
set_property -dict {PACKAGE_PIN E18  IOSTANDARD LVCMOS25} [get_ports {usr_led[6]}]
set_property -dict {PACKAGE_PIN F16  IOSTANDARD LVCMOS25} [get_ports {usr_led[7]}]
...
set_property PACKAGE_PIN H6 [get_ports phy_sgmii_rx_p]
set_property PACKAGE_PIN J4 [get_ports phy_sgmii_tx_p]
set_property PACKAGE_PIN G8 [get_ports phy_sgmii_clk_p]
...
set_property DRIVE 12 [get_ports phy_reset_n]
set_property PACKAGE_PIN N30 [get_ports phy_int_n]
set_property IOSTANDARD LVCMOS25 [get_ports phy_int_n]
