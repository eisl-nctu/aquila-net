...
#define configMTIME_BASE_ADDRESS        ( 0xF0000000UL )
#define configMTIMECMP_BASE_ADDRESS     ( 0xF0000008UL )
...
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 1U * 24U * 256U ) )
...
#define configNUM_THREAD_LOCAL_STORAGE_POINTERS 3 //add for fat
