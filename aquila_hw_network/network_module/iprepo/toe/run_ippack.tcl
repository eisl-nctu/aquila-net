...
set solution_dir "/home/ydlee/Thesis_workspace/progress/2022-04-03/fpga-network-stack_2019.1/build/hls/toe/toe_prj/solution1"
...
set Interfaces {
    ...
    m_axis_accept_conn_rsp_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_accept_conn_rsp_V"
        has_tready "1"
        ports {
            TDATA 64
        }
...
## System Info
set user_parameters_list {clk_period 6.4 machine 64 combinational 0 latency 31 II x}
